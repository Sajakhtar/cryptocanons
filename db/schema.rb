...
ActiveRecord::Schema.define(version: 2021_08_31_072042) do
  ...
  create_table "bookmarked_articles", force: :cascade do |t|
    ...
    t.index ["topic_id"], name: "index_bookmarked_articles_on_topic_id"
  ...
  add_foreign_key "bookmarked_articles", "topics"
